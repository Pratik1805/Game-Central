...
const Nav = () => {
  ...
  return (
    <div className=" bg-primary py-8 flex justify-evenly items-center">
      ...
      <motion.div className="sm:block hidden px-8" variants={variants} initial="initial" animate="animate">
      ...
      <motion.div className="sm:block hidden" variants={variants} initial="initial" animate="animate">
