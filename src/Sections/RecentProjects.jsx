...
const RecentProjects = () => {
  ...
  return (
    <motion.section
      ...
      animate="animate"
    >
      <motion.div className=" flex items-center justify-center flex-col max-container px-2 py-4 bg-center bg-no-repeat bg-cover ">
        ...
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-8">
          {recentProjects.map((items) => (
            <motion.div
              key={items.id}
              className=" flex flex-col items-center justify-center rounded-md overflow-hidden px-2 py-4"
            >
              <motion.img
                src={items.src}
                alt="project img"
              ...
              />
              <motion.h3 className=" text-white mt-4 text-3xl hover:text-secondary hover:cursor-pointer">
                {items.title}
              </motion.h3>
            </motion.div>
          ))}
