...
const ContactUs = () => {
  ...
  return (
    <motion.div id="join" className="flex flex-col items-center justify-center sm:w-[60%] w-full m-auto shadow-xl rounded-3xl px-2 py-4"
      ...
      <motion.div className=" mt-8 w-full px-4 py-2">
        <motion.form action="">
          <motion.div className="flex gap-4 sm:flex-row flex-col px-2 py-2">
            <motion.div className=" w-full rounded-full border border-white overflow-hidden bg-transparent">
              <motion.input
                type="text"
          ...
          <motion.div className="flex gap-4 sm:flex-row flex-col  px-2 py-2">
            <motion.div className=" w-full rounded-3xl   border border-white overflow-hidden bg-transparent">
              <motion.textarea
                rows={10}
                cols={50}
